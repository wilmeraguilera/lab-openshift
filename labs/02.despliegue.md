...
* Dar clic en View Logs y se evidencia que está se está ejecutando la compilación del proyecto. Este proceso tardará un poco de acurdo a la cantidad de dependencias que deban ser descargadas y el tiempo de construcción de la imagen.

![Logs Build](img/openjdk-template-build-logs.png)

* Cuando el Build termina debemos ver una salida en los logs similar a la siguiente imagen:
...
La anterior variable de entorno del build también puede ser especificada en el comando new-app.
...
Tomar la ruta que en mi caso es lab-openshift-apps-user1.apps-crc.testing en un navegador. Debemos ver la pantalla de swagger del api.
