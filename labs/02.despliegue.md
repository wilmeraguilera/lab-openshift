...
* Dado que le entregamos a Openshift las fuentes de la aplicación, el paso que se ejecutará será el Build de la aplicación y posteriormente del Deploy. Vamos a la pantalla **Topology** y damos clic sobre la aplicación para ver el detalle.
