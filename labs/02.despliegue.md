...
* Dar clic en **Create**. 
* Con el paso anterior se crearan una serie de recursos en Openshift entro lo que estan el ImageStream, BuildConfig, DeploymentConfig, Service y Route.
* Dado que le entregamos a Openshift las fuentes de la aplicación, el paso que se ejecutará será el Build de la aplicación. Vamos a la pantalla **Topology**
