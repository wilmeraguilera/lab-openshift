...
12. Para que tome los cambios de config map dentro de nuestra aplicación es necesario hacer un nuevo deploy (Importante tener en cuenta que no estamos cambiando la imagen de contenedor).
