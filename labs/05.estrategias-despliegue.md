...
A nivel de Openshift existen varias estrategias de despliegue que podemos usar de acuerdo a las necesidades:
...
Es una estrategia que busca reducir el tiempo de indisponibilidad de una aplicación al momento de realizar un despliegue. Se requiere tenes dos ambientes idénticos llamados "Blue" y "Green, uno de ellos tendrá la version estable y el otro la nueva versión. Cuando todo este correcto lo único que se cambia el la ruta para que apunte al ambiente con la nueva versión.
...
5. Verificación creación de aplicaciones.
